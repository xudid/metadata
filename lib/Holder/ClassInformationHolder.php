                    ...
                    foreach ($comments as $key => $comment) {
                        if (preg_match("#^@var#", $comment, $parts)) {
                           //TODO process @var to get the var Type
                            ...
                            if (preg_match("#^@(ManyToMany)\([\w]+=\"([a-zA-Z]*)\"|(ManyToOne)\([\w]+=\"([a-zA-Z]*)\"|OneToMany\([\w]+=\"([a-zA-Z]*)\"#", $comment,$parts)) {
                                if (array_key_exists(1,$parts)&& array_key_exists(2,$parts)) {
                                    ...
                                    throw new Exception("Malformed Association annotation in : ".$this->className." for field :".$fieldname);
                                }
                            }
                        }
